...
"""
#__WebCrawler__#
This is a web crawler designed for extracting urls from the CNN International website.
"""
#Change this to where you want the urls saved to.
saveLocation = "links/"

#Starting Url and declared variables etc..
start_url = "http://edition.cnn.com"
spider_list = []
crawled_list = []
scrape_list = []
scrapeD_list = []
...
link_scan = re.compile('http://edition.cnn.com')
...
try:
	with open(saveLocation+"_CRAWLED_URLS.txt") as f:
...
#Searching for website at start of url and adding to url list		
		tt = re.findall(link_scan, str(new_url))
